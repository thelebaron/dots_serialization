...
namespace Unity.Entities.Editor.Tests
{
    ...
    class EntityHierarchyDefaultGroupingStrategyIntegrationTests
    {
        ...
        IEnumerator SkipAnEditorFrameAndDiffingUtility()
        {
            ...
            m_EntityHierarchyDiffer.TryUpdate(out _);
        }
        ...
        public virtual void Setup()
        {
            ...
            m_EntityHierarchyDiffer = new EntityHierarchyDiffer(m_Container);
            m_EntityHierarchyDiffer.TryUpdate(out _);
        ...
        public IEnumerator SubsceneBasedParenting_Scenario1()
        {
            ...
            subScene.AddChildren(
                new EntityHierarchyNodeId(NodeKind.Entity, entityId++ ,0),// "go" Converted Entity
                new EntityHierarchyNodeId(NodeKind.Entity, entityId, 0)); // "go2" Converted Entity
            m_AssertHelper.AssertHierarchyByKind(expectedHierarchy.Build());
            ...
            subScene.AddChild(new EntityHierarchyNodeId(NodeKind.Entity, entityId++, 0))    // "go" Converted Entity
                        .AddChild(new EntityHierarchyNodeId(NodeKind.Entity, entityId, 0)); // "go2" Converted Entity
            m_AssertHelper.AssertHierarchyByKind(expectedHierarchy.Build());
