...
namespace PrefabSerialization.Editor
{
    ...
    public class CommentHierarchyIcon
    {
        ...
        {
            Icon       = AssetDatabase.LoadAssetAtPath("Packages/com.thelebaron.SaveTools/Gizmos/SaveEntityToDisk icon.png", typeof(Texture2D)) as Texture2D;
            ParentIcon = AssetDatabase.LoadAssetAtPath("Packages/com.thelebaron.SaveTools/Gizmos/SaveEntityToDisk icon.png", typeof(Texture2D)) as Texture2D;
